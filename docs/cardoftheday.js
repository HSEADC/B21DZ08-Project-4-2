...
;// CONCATENATED MODULE: ./src/components/M_TarotCardReading/M_TarotCardReading.jsx
...
;// CONCATENATED MODULE: ./src/components/O_TarotCardInfo_CardOfTheDay/O_TarotCardInfo_CardOfTheDay.jsx
...
;// CONCATENATED MODULE: ./src/components/O_MoreFortuneTellings/O_MoreFortuneTellings.jsx
...
;// CONCATENATED MODULE: ./src/cardoftheday.jsx
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (0,airtableData/* getTarotCards */.Kj)().then(function (data) {
    ...
    console.log(requiredCard); // allTarotCards.forEach((tarotCard) => {
    ...
    var root = (0,client/* createRoot */.s)(document.querySelector('.CardContainer_CardOfTheDay'));
