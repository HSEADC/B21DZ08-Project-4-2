...
;// CONCATENATED MODULE: ./src/components/O_TarotCardInfo/O_TarotCardInfo.jsx
...
;// CONCATENATED MODULE: ./src/cards/cardTelling.jsx
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (0,airtableData/* getTarotCards */.Kj)().then(function (data) {
    ...
    var root = (0,client/* createRoot */.s)(document.querySelector('.CardContainer'));
