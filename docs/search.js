...
/* harmony export */   "I": () => (/* binding */ getSearchData)
/* harmony export */ });
/* unused harmony export getTarotCards */
...
(() => {
"use strict";
/* harmony import */ var _airtableData_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(605);
...
function createContentCard(contentItemData) {
  ...
  contentItemImage.classList.add('A_CardArticleImage'); // contentItemCover.src = contentItemData.image
...
function rerenderSearchedContent(requestText) {
  var contentItemsContainer1 = document.querySelector('.W_SearchedArticleCards');
  contentItemsContainer1.innerHTML = '';
  var contentItemsContainer2 = document.querySelector('.O_SearchedTarotCards');
  ...
  function renderNothingFound() {
    var contentItemsContainer = document.querySelector('.A_NothingFound');
...
document.addEventListener('DOMContentLoaded', function () {
  (0,_airtableData_js__WEBPACK_IMPORTED_MODULE_0__/* .getSearchData */ .I)().then(function (data) {
    content = data;
    initSearch();
  });
});
